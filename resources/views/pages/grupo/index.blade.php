                    ...
                    <div class="grupo-card">
                        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                            ...
                            <div class="p-6">
                                ...
                                {{-- <a href="{{ route('admin.grupo.show', $grupo->id) }}" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 active:bg-blue-600 disabled:opacity-25 transition">Ingresar</a> --}}
                            </div>
                        </div>
                    </div>
                @endforeach
