<x-authentication-layout>
    <h1 class="text-3xl flex text-slate-800 dark:text-slate-100 font-bold mb-6">{{ __('Iniciar sesión') }} <img
    ...
    <style>
        ...
        .hover-bg:hover {
            background: #005080;
            /* Cambia este color al color que desees para el hover */
        }
    </style>
</x-authentication-layout>
