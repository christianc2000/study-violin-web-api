        ...
        <div class="space-y-8">
            ...
            <div>
                <h3 class="text-xs uppercase text-slate-500 font-semibold pl-3">
                    ...
                    <span class="lg:hidden lg:sidebar-expanded:block 2xl:block">Profesor</span>
                </h3>
                <ul class="mt-3">
                    <!-- Dashboard -->
                        ...
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if (Route::is('admin.estudiante.index')) {{ '!text-indigo-500' }} @endif" href="{{route('admin.estudiante.index')}}">
                            <div class="flex items-center">
                                <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                    ...
                                    <path class="fill-current @if(in_array(Request::segment(1), ['grupo'])){{ 'text-indigo-300' }}@else{{ 'text-slate-400' }}@endif" d="M12 6a3 3 0 110-6 3 3 0 010 6zm2 18h-4a1 1 0 01-1-1v-6H6v-6a3 3 0 013-3h6a3 3 0 013 3v6h-3v6a1 1 0 01-1 1z" />
                                </svg>
                                <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Estudiante</span>
                            </div>
                        </a>
                    </li>
                    <!-- Grupo -->
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(1), ['grupo'])){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if (Route::is('admin.grupo.index') || Route::is('admin.grupo.create') || Route::is('admin.grupo.edit') || Route::is('admin.grupo.show')|| Route::is('admin.grupo.chat')) {{ '!text-indigo-500' }} @endif" href="{{route('admin.grupo.index')}}">
                            <div class="flex items-center">
                                <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
